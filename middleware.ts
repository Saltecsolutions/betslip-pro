...
export async function middleware(request:NextRequest){
 ...
 const protectedPath=['/review','/support','/dashboard','/purchases','/tipster/','/admin','/account','/notifications'].some(p=>path.startsWith(p))||path==='/tipster';
...
export const config={matcher:['/review/:path*','/support/:path*','/dashboard/:path*','/purchases/:path*','/tipster/:path*','/admin/:path*','/account/:path*','/notifications/:path*']};
