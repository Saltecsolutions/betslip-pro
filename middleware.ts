...
export async function middleware(request:NextRequest){
 ...
 const protectedPath=['/support','/dashboard','/purchases','/tipster/','/admin','/account','/notifications'].some(p=>path.startsWith(p))||path==='/tipster';
...
export const config={matcher:['/support/:path*','/dashboard/:path*','/purchases/:path*','/tipster/:path*','/admin/:path*','/account/:path*','/notifications/:path*']};
