...
insert into public.policy_acceptances(user_id,document,version,locale) select id,d,case when d='seller' then '2026-09-05-v2' else '2026-09-05' end,'en' from support_finance_test cross join unnest(array['terms','privacy','adult','seller']) d;
